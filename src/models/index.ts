...
import { Invoice, InvoiceStatus, PaymentMethod } from './invoice.model.js'
import { ServicesInvoice } from './servicesInvoice.model.js'
import { Receipt } from './receipt.model.js'
import { MiscellaneousBilling } from './miscellaneousBilling.model.js'
import { UnitMiscellaneousItem } from './unitMiscellaneousItem.model.js'
import { PatientMiscellaneousItem } from './patientMiscellaneousItem.model.js'
import { CarriedForwardInvoice } from './carriedForwardInvoice.model.js'
import { InvoiceDocument } from './invoiceDocument.model.js'
import { GstTaxSettings } from './gstTaxSettings.model.js'
import {
  InventoryStock,
...
// ── Billing Module Associations (rely-assist architecture) ────────────────────
Invoice.hasMany(ServicesInvoice, { foreignKey: 'invoiceId', as: 'services' })
ServicesInvoice.belongsTo(Invoice, { foreignKey: 'invoiceId', as: 'invoice' })

Invoice.hasMany(MiscellaneousBilling, { foreignKey: 'invoiceId', as: 'miscellaneousItems' })
MiscellaneousBilling.belongsTo(Invoice, { foreignKey: 'invoiceId', as: 'invoice' })
PropertyUnit.hasMany(MiscellaneousBilling, { foreignKey: 'unitId', as: 'miscellaneousBilling' })
MiscellaneousBilling.belongsTo(PropertyUnit, { foreignKey: 'unitId', as: 'unit' })
...
Resident.hasMany(Receipt, { foreignKey: 'residentId', as: 'receipts' })
Receipt.belongsTo(Receipt, { foreignKey: 'residentId', as: 'resident' })

Resident.hasMany(UnitMiscellaneousItem, { foreignKey: 'residentId', as: 'miscellaneousItems' })
UnitMiscellaneousItem.belongsTo(Resident, { foreignKey: 'residentId', as: 'resident' })
PropertyUnit.hasMany(UnitMiscellaneousItem, { foreignKey: 'unitId', as: 'unitMiscellaneousItems' })
UnitMiscellaneousItem.belongsTo(PropertyUnit, { foreignKey: 'unitId', as: 'propertyUnit' })
...
export {
  ...
  PatientMiscellaneousItem,
  CarriedForwardInvoice,
  InvoiceDocument,
  GstTaxSettings,
