...
export interface VenueAttributes extends BaseAttributes {
  name: string
  occupancy: number
  price: number
  keyFeatures: string
...
export class Venue extends BaseModel<VenueAttributes, VenueCreationAttributes> implements VenueAttributes {
  declare name: string
...
Venue.init(
  ...
  { sequelize, tableName: 'venues', timestamps: true },
)
