...
export interface ResidentMedicationAttributes extends BaseAttributes {
  residentId: string
  locationId: string
...
export type ResidentMedicationCreationAttributes = Optional<
  ResidentMedicationAttributes,
  | 'id'
  | 'appointmentId'
  | 'endDate'
  | 'note'
...
export class ResidentMedication
  extends BaseModel<ResidentMedicationAttributes, ResidentMedicationCreationAttributes>
  implements ResidentMedicationAttributes
{
...
ResidentMedication.init(
  ...
  {
    sequelize,
    tableName: 'resident_medications',
    timestamps: true,
    indexes: [
      { fields: ['residentId'], name: 'idx_resident_medications_resident' },
      { fields: ['locationId'], name: 'idx_resident_medications_location' },
      { fields: ['inventoryItemId'], name: 'idx_resident_medications_item' },
    ],
  },
)
