import centerInventoryRouter from './center-inventory.routes.js'
...
apiRouter.use('/center-inventory', centerInventoryRouter)
apiRouter.use('/assets', assetRouter)
apiRouter.use('/location/:locationId/assets', assetRouter)
apiRouter.use('/tickets', ticketRouter)
apiRouter.use('/location/:locationId/tickets', ticketRouter)
apiRouter.use('/fnb/attendance', fnbRouter)
apiRouter.use('/web/fnb/attendance', fnbRouter)
...
apiRouter.use('/event-requests', eventRequestRouter)
