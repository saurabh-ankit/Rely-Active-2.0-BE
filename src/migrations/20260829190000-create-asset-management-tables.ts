...
export async function up({ context: queryInterface }: { context: QueryInterface }): Promise<void> {
  ...
  await queryInterface.createTable('asset_assignments', {
    ...
    assigneeType: {
      type: DataTypes.ENUM('employee', 'patient', 'room'),
      allowNull: false,
    },
    assigneeId: {
      type: DataTypes.UUID,
...
export async function down({ context: queryInterface }: { context: QueryInterface }): Promise<void> {
  await queryInterface.dropTable('asset_compliance_training')
  await queryInterface.dropTable('asset_compliance_certifications')
  await queryInterface.dropTable('asset_compliance_inspections')
  await queryInterface.dropTable('asset_calibrations')
  await queryInterface.dropTable('asset_warranties')
  await queryInterface.dropTable('asset_service_logs')
  await queryInterface.dropTable('asset_assignments')
  await queryInterface.dropTable('assets')
  await queryInterface.dropTable('asset_item_locations')
  await queryInterface.dropTable('asset_items')
  await queryInterface.dropTable('asset_vendor_custom_fields')
  await queryInterface.dropTable('asset_vendor_locations')
  await queryInterface.dropTable('asset_vendors')
  await queryInterface.dropTable('asset_category_locations')
