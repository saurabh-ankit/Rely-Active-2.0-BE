...
export async function up({ context: queryInterface }: { context: QueryInterface }): Promise<void> {
  ...
  if (!tables.includes('billing_unit_residents')) {
    ...
    await queryInterface.addIndex('billing_unit_residents', ['residentId'], { name: 'idx_billing_unit_residents_resident_id' })
    await queryInterface.addIndex('billing_unit_residents', ['isActive'], { name: 'idx_billing_unit_residents_is_active' })
  ...
  if (!tables.includes('billing_price_plans')) {
    ...
    await queryInterface.addIndex('billing_price_plans', ['propertyId'], { name: 'idx_billing_price_plans_property_id' })
    await queryInterface.addIndex('billing_price_plans', ['productId', 'propertyId', 'effectiveFrom'], { name: 'idx_billing_price_plans_lookup' })
  ...
  if (!tables.includes('billing_accounts')) {
    ...
    await queryInterface.addIndex('billing_accounts', ['primaryResidentId'], { name: 'idx_billing_accounts_primary_resident_id' })
    await queryInterface.addIndex('billing_accounts', ['status'], { name: 'idx_billing_accounts_status' })
    await queryInterface.addIndex('billing_accounts', ['isActive', 'isDeleted'], { name: 'idx_billing_accounts_active' })
  ...
  if (!tables.includes('billing_parties')) {
    ...
    await queryInterface.addIndex('billing_parties', ['familyMemberId'], { name: 'idx_billing_parties_family_member_id' })
  ...
  if (!tables.includes('billing_subscriptions')) {
    ...
    await queryInterface.addIndex('billing_subscriptions', ['billingAccountId'], { name: 'idx_billing_subs_account_id' })
    ...
    await queryInterface.addIndex('billing_subscriptions', ['fnbPackageId'], { name: 'idx_billing_subs_fnb_package_id' })
  ...
  if (!tables.includes('billing_events')) {
    ...
    await queryInterface.addIndex('billing_events', ['sourceModule', 'sourceType', 'sourceId'], { name: 'idx_billing_events_source' })
  ...
  if (!tables.includes('billing_invoices')) {
    ...
    await queryInterface.addIndex('billing_invoices', ['periodStart', 'periodEnd'], { name: 'idx_billing_invoices_period' })
  ...
  if (!tables.includes('billing_payment_allocations')) {
    ...
    await queryInterface.addIndex('billing_payment_allocations', ['paymentId'], { name: 'idx_billing_payment_alloc_payment_id' })
    await queryInterface.addIndex('billing_payment_allocations', ['invoiceId'], { name: 'idx_billing_payment_alloc_invoice_id' })
    await queryInterface.addIndex('billing_payment_allocations', ['billingAccountId'], { name: 'idx_billing_payment_alloc_account_id' })
  ...
  if (!tables.includes('billing_runs')) {
    ...
    await queryInterface.addIndex('billing_runs', ['billingPeriodStart', 'billingPeriodEnd'], { name: 'idx_billing_runs_period' })
  ...
  if (!tables.includes('billing_ledger_entries')) {
    ...
    await queryInterface.addIndex('billing_ledger_entries', ['billingAccountId', 'entryDate'], { name: 'idx_ledger_account_statement' })
